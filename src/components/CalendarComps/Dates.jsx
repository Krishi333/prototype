...
function Dates () {
    return (
        <>
            ...
            <button type="button" className="btn btn-warning" style={{width: '13%', height: '150px'}}>Friday 31th</button>
            <button type="button" className="btn btn-warning" style={{width: '13%', height: '150px'}}>Saturday 1st</button>
            <button type="button" className="btn btn-warning" style={{width: '13%', height: '150px', marginRight: '1%'}}>Sunday 2nd</button>
        </>
    )
}
