...
function PostPage({onClickBack, onClickPost, onClickEmployee}) {
    ...
    return (
        <div className="p-3">
            ...
            <div className="border border-dark rounded" style={{marginTop: "1%", backgroundColor: "white"}}>
                ...
                <button className="btn border border-dark rounded" style={{width: "29%", marginRight: "1%", marginLeft: "1%", marginBottom: "1%", 
                    color: "oklch(0.15 0.03 82)", backgroundColor: "white"}}>Review Changes</button>
                <button className="btn border border-dark rounded" style={{width: "43%", marginBottom: "1%", marginRight: "1%", color: "oklch(0.15 0.03 82)", 
                    backgroundColor: "white"}}>Change View</button>
                <button className="btn border border-dark rounded" style={{width: "24%", marginBottom: "1%", color: "oklch(0.15 0.03 82)", 
                    backgroundColor: "white"}} onClick={onClickEmployee}>Employee View</button>
            </div>
