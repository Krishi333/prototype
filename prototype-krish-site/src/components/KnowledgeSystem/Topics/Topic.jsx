...
function Topic({topicName, tags, onClickPostPage}) {
    ...
    return (
        <div className="border border-dark rounded" style={{marginTop: "1%", textAlign: "center", backgroundColor: "white"}}>
            ...
            <span className="border border-dark rounded" style={{float: "right", marginRight: "1%", marginBottom: "1%", backgroundColor: "lightBlue",
